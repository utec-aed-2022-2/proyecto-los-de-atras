...
public:
    ...
    void myTxs(const std::string &username, const std::string &password, const std::string& path="./assets/users/session.txt");
    void myTxsDate(const std::string &username, const std::string &password, const std::string& path="./assets/users/session.txt");
    void myTxsAmount(const std::string &username, const std::string &password, const std::string& path="./assets/users/session.txt");
    void myTxsDateRange(const std::string& username, const std::string& password, const std::string& start, const std::string& end, const std::string& path="./assets/users/session.txt");
    void myTxsAmountRange(const std::string& username, const std::string& password, float start, float end, const std::string& path="./assets/users/session.txt");
    void myMaxTxD(const std::string &username, const std::string &password, const std::string& path="./assets/users/session.txt");
    void myMinTxD(const std::string &username, const std::string &password, const std::string& path="./assets/users/session.txt");
    void myMaxTxA(const std::string &username, const std::string &password, const std::string& path="./assets/users/session.txt");
    void myMinTxA(const std::string &username, const std::string &password, const std::string& path="./assets/users/session.txt");
...
void Blockchain::myTxs(const std::string &username, const std::string &password, const std::string& path) {
    ...
    for (int i=0; i<transactions.SIZE(); ++i) {
        ...
        out << transaction->string1 << " " << transaction->string2 << " " << transaction->amount << " " << transaction->date << std::endl;
    }
    out.close();
}
...
void Blockchain::myTxsAmountRange(const std::string &username, const std::string &password, float start, float end,
    ...
    std::stringstream ss; ss<<username; ss<<password;
    DoubleList<transaction*> transactions = usersHash.get(ss.str())->data->orderByAmount.makeListRange(new transaction{"", "", start, ""}, new transaction{"", "", end, ""});
    std::ofstream out(path);
